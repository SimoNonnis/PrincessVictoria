...
?>
  ...
  <section class="u-displayTable [ top-section-wrapper ] [ amberBorder ]">
    ...
    <div class="top-section top-section--skin top-section--bkg ">
      ...
      <a href="mailto:info@princessvictoria.co.uk?subject=Princess Victoria Private Dining Enquiry" class="btn btn--topSection borderDouble button-dark">Email us</a>
  ...
  <div class="[ grid-element ] magicBox [ amberBorder ]" id="eventEnquiry-Open" >
    <div class="magicBox--dark1 center-parent aboutBox-bkg" style="background-image: url('<?php echo get_bloginfo('template_directory');?>/images/private-dining/private-dining-illustration.png');">
  ...
  <div class="[ grid-element ] magicBox magicBox--fancy-zoom desktop-hidden [ amberBorder ]">
  ...
  <!-- Rect1 -->
  <div class="[ grid-element--rect magicBox--rectCopy1 ] magicBox magicBox--dark [ amberBorder ]">
    <div class="rect-copy-wrapper u-cf" style="overflow:auto;">
      ...
      <p class="column column-right">
        <strong>The Room Upstairs:</strong> <?php echo $private_dining_capacity_spec1; ?> <br>
        <strong>Dining Room:</strong> <?php echo $private_dining_capacity_spec2; ?> <br>
        <strong>Bar:</strong> <?php echo $private_dining_capacity_spec3; ?> <br>
        <strong>Entire venue:</strong> 280 standing
      </p>
    </div>
  </div> 
  ...
  <div class="[ grid-element ] magicBox magicBox--fancy-zoom lap-mob-hidden [ amberBorder ]">
    <div class="cover <?php if( $private_dining_bot_square_title && $private_dining_bot_square_link ): ?>fancy-zoom<?php endif; ?>" style="background-image: url('<?php echo $private_dining_bot_square_img['sizes']['386x340']; ?>')"></div>
    ...
    <?php if( $private_dining_bot_square_title && $private_dining_bot_square_link ): ?>
      <a href="<?php echo $private_dining_bot_square_link; ?>" class="lap-mob-hidden"></a>
    <?php endif; ?>
  </div>
