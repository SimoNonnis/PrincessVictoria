...
?>
  ...
  <section class="u-displayTable [ top-section-wrapper ] [ amberBorder ]">
    ...
    <div class="top-section top-section--skin top-section--bkg top-section--bkg-findUs u-cf " style="background-image: url('<?php echo get_bloginfo('template_directory');?>/images/illustration.png');">
      ...
      <p>
        ...
        or email us: <a class="u-textBreak" href="mailto:info@princessvictoria.co.uk?subject=Princess Victoria Reservation Enquiry">info@princessvictoria.co.uk</a>
      </p>
