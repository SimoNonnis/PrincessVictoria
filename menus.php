...
?>
  ...
  <!-- Rect1 -->
  <div class="[ grid-element--rect magicBox--rectCopy ] magicBox magicBox--light  [ amberBorder ]">
  ...
  <div class="[ grid-element ] magicBox lap-mob-hidden [ amberBorder ]">
  ...
  <!-- Rect2 -->
  <div class="[ grid-element--rect magicBox--rectCopy ] magicBox magicBox--dark1 [ amberBorder ]">
    <div class="rect-copy-wrapper">
