...
?>
  ...
  <div class="hero-container u-cf [ amberBorder ]">
    
    <div class="slider-container u-cf">
    ...
    <div class="slider-aside u-cf ">
      <h2 class="u-margin-t-flush u-textUpperCase [ slider-aside__title ]">Welcome to <span class="u-inlineBlock">The Princess Victoria</span></h2>
      <div class="slider-aside__child"><img src="<?php echo get_bloginfo('template_directory');?>/images/illustration.gif" alt="Illustration"></div>
      <div class="slider-aside__child">
        ...
        <p class="contact-details-address [ u-margin-t-flush u-textCapitalize ]">
          <a href="https://goo.gl/maps/PE5Eg" target="_blank" alt="View on Google Maps">
            <?php echo $address1; ?><br>
            <?php echo $address2; ?> <?php echo $address3; ?>
          </a>
        </p>
      </div>
    </div>
  ...
  <?php if( have_rows('home_page_squares') ): ?>
    ...
    ?>
      ...
      <div class="[ grid-element ] [ amberBorder ] magicBox magicBox--fancy-zoom <?php if( $home_sq_mobile_hidden ): ?>mob-hidden<?php endif; ?>">
  ...
  ?>  
  <div class="[ grid-element ] magicBox lastBlogPostBox [ amberBorder ]">
    <div class="magicBox-overlay magicBox--dark lastBlogPost center-parent">
      <div class="lotOfCopy lotOfCopy--homeBlogPost center-child u-textCenter">
        <h3 class="magicBox__title magicBox__title--no-shadow lastBlogPostBox__title">
        ...
        <a href="<?php echo $home_post_link; ?>" class="btn borderDouble button-dark">Read More</a>
      </div>
    </div>
  </div>
    
  <div class="[ grid-element ] magicBox lastBlogPostBoxImage lap-mob-hidden [ amberBorder ]">
  ...
  <!--Booking Widget-->
  <div class="[ grid-element ] magicBox bookingWidgetBoxImage mob-hidden [ amberBorder ]">
    <div class="cover" style="background-image: url('<?php echo $booking_img['sizes']['386x340']; ?>')"></div>
  </div>


  <div class="[ grid-element ] magicBox magicBox--light bookingWidgetBox u-overflowVisible  [ amberBorder ]">
